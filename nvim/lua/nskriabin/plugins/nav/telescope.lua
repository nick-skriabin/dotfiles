...
return {
    ...
    keys = {
        ...
        {
            "<leader><space>",
            Util.telescope("files", { path_display = path_display }),
        ...
        {
            "<leader>ff",
            Util.telescope("files", { cwd = false, path_display = path_display }),
            desc = "Find Files (cwd)",
        },
        { "<leader>fr", "<cmd>Telescope oldfiles<cr>", desc = "Recent" },
        {
            "<leader>fR",
            Util.telescope("oldfiles", { cwd = vim.loop.cwd(), path_display = path_display }),
            desc = "Recent (cwd)",
        },
